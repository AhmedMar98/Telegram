...
def main() -> None:
    ...
    logger.info("   Tables (v4.1):")
    logger.info("     accounts, channels, links, link_embeddings,")
    logger.info("     classification_logs, vitality_checks, llm_provider_state, audit_events,")
    logger.info("     semantic_cache, daily_summaries, tenants,")
    logger.info("     worker_registry, subscriptions")
    logger.info("")
